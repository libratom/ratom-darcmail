...
object, "eaxs_helpers". This can be imported with "from lib.eaxs_helpers import eaxs_helpers".

Each module file in ./eaxs_helpers is expected to have a "main" function that provides the API. 
For example, eaxs_helpers.close_folders() will be equivalent to the underlying function, 
close_folders.main(). """
