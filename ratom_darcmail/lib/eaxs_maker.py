...
class EAXSMaker():
    ...
    @staticmethod
    def close_folders(folder, opened_folders):
        """ Looks at the current @folder depth in the context of previously @openen_folders and 
        returns a list of folders to close. Designed to accomodate EAXS' use of recursive <Folder>
        elements.
        
        Args:
            - folder (lib.folder_object.FolderObject): The most recently opened folder within the
            EAXS context.
            - opened_folders (list): The list of non-closed folders within the EAXS context.
        
        Returns:
            list: The return value.
            Each item in the list is a lib.folder_object.FolderObject that needs to be immediately 
